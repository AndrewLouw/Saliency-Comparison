...
class LimeImageExplainer(object):
    ...
    def explain_instance(self, image, classifier_fn, labels=(1,),
        ...
        Args:
            ...
            hide_color: the colour to be used in the mask
            ...
            qs_max_dist: the maximum size of a superpixel,
            method: 'mask' or 'inverse' mask replaces a superpixel with a colour,
                inverse makes it 1 - its colour.
            change_fraction: the rough proportion of superpixels changed each iteration
        ...
        segments = quickshift(image, kernel_size=qs_kernel_size,
                              max_dist=qs_max_dist, ratio=0.2, random_seed=random_seed)
    ...
    def data_labels(self,
        ...
        if change_fraction>0:
            change_fraction = int(1/change_fraction)

        data = self.random_state.randint(0, change_fraction,num_samples * n_features)\
        ...
        for row in data:
            ...
            if method =='mask':
                ...
                raise ValueError('methond not availiable: %d'%method)
            imgs.append(temp)
